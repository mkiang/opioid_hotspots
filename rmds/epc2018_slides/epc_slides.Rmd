---
title: "Geographic Variation in Opioid Mortality in the United States by Race/Ethnicity, 1999--2016"
...
# Background: the national US opioid epidemic
...
1. Systematically describe the opioid epidemic across geography (state), race/ethnicity, and opioid type.
    ...
    - The *current* epidemic in terms of level of mortality and current rate of increase
2. Identify "epidemic hotspots" --- areas with high mortality and current rapid increases
...
2. Calculate age-standardized rates by state, race/ethnicity, and opioid type
    ...
    - Natural (prescription); heroin; and synthetic (e.g. fentanyl) opioids
3. Joinpoint regression to identify significant changes
