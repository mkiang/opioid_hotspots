...
\newif\ifbibliography
\hypersetup{
            pdftitle={Geographic Variation in Opioid Mortality in the United States by Race/Ethnicity, 1999--2016},
...
\setbeamertemplate{footline}
{
  ...
  \begin{beamercolorbox}[wd=.6\paperwidth,ht=2.25ex,dp=1ex,right]{date in head/foot}%
    \usebeamerfont{date in head/foot} Opioid Epidemic Hotspots (\texttt{tiny.cc/epc2018}) \hspace*{2em}
